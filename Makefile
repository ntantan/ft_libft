...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/11/26 11:47:51 by ntan              #+#    #+#              #
#    Updated: 2021/12/10 18:04:40 by ntan             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRCS			=	ft_isalnum.c ft_isprint.c ft_memcmp.c  ft_putchar_fd.c \
					ft_split.c ft_strlcat.c ft_strncmp.c ft_substr.c ft_atoi.c \
					ft_isalpha.c ft_itoa.c ft_putendl_fd.c ft_strchr.c \
					ft_strlcpy.c ft_strnstr.c ft_tolower.c ft_bzero.c \
					ft_isascii.c ft_memcpy.c ft_memmove.c ft_putnbr_fd.c  \
